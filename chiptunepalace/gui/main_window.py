...
from PySide6.QtGui import QFont, QPalette, QColor, QIcon, QPixmap, QAction, QTextDocument
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.status_bar.setStyleSheet("QStatusBar { background: rgba(13, 13, 26, 255); color: #6a7080; font-family: 'Courier New'; font-size: 10px; }")
    ...
    def on_playback_warning(self, warn_msg):
        ...
        self.status_bar.setStyleSheet("QStatusBar { background: #2a1b0a; color: #ff9f00; font-family: 'Courier New'; font-size: 10px; border-top: 1px solid #ff9f00; }")
        ...
        QTimer.singleShot(10000, lambda: self.status_bar.setStyleSheet(
            "QStatusBar { background: rgba(13, 13, 26, 255); color: #6a7080; font-family: 'Courier New'; font-size: 10px; }"
        ))
